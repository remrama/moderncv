...
\social[youtube]{c/jdoeschannel}                   % optional, remove / comment the line if not wanted; Custom URL             - can be shortened by removing 'c/'
...
\social[youtube]{@jdoeschannel}                    % optional, remove / comment the line if not wanted; Handle URL (Channel)
\social[youtube]{@jdoe}                            % optional, remove / comment the line if not wanted; Handle URL (User)
